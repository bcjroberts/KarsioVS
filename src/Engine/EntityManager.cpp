...
Entity* EntityManager::createGroundPlane() {
	...
	ComponentManager::getInstance()->addRendererComponent(entity, ModelManager::getModelData("plane"), glm::vec3(0, 0, 0), glm::quat(glm::vec3(0, 0, -1.57f)), glm::vec3(10, 10, 100));
